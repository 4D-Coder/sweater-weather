    ...
    context 'When successful' do
      it 'get /forecast' do
        VCR.use_cassette('GET mapquest coordinates', record: :new_episodes) do
          ...
          expect(forecast_data.keys).to eq(%i[id type attributes])
          ...
          expect(attributes.keys).to eq(%i[current_weather daily_weather hourly_weather])
